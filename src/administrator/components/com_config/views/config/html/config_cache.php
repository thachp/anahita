...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="cachetime" size="5" value="<?php echo $config->cachetime; ?>" />
		...
		<?php if ($config->cache_handler == 'memcache' || $config->session_handler == 'memcache') : ?>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td>
				...
				<input class="text_area" type="text" name="memcache_settings[servers][0][host]" size="25" value="<?php echo @$config->memcache_settings['servers'][0]['host']; ?>" />
				<br /><br />
				<?php echo JText::_( 'Port' ); ?>:
				<input class="text_area" type="text" name="memcache_settings[servers][0][port]" size="6" value="<?php echo @$config->memcache_settings['servers'][0]['port']; ?>" />
			</td>
		</tr>
		<?php endif; ?>
		</tbody>
