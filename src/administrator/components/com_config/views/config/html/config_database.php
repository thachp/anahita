...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="dbtype" size="30" value="<?php echo $config->dbtype; ?>" />
			</td>
		</tr>
		<tr>
			<td width="185" class="key">
			...
			<td>
				<input class="text_area" type="text" name="host" size="30" value="<?php echo $config->host; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="user" size="30" value="<?php echo $config->user; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="db" size="30" value="<?php echo $config->db; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="dbprefix" size="10" value="<?php echo $config->dbprefix; ?>" />
