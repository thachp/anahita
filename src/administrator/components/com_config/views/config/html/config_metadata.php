...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<textarea class="text_area" cols="50" rows="3" style="width:400px; height:50px" name="MetaDesc"><?php echo $config->MetaDesc; ?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				<textarea class="text_area" cols="50" rows="3" style="width:400px; height:50px" name="MetaKeys"><?php echo $config->MetaKeys; ?></textarea>
			</td>
		</tr>
		</tbody>
	</table>
