...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="mailfrom" size="30" value="<?php echo $config->mailfrom; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="fromname" size="30" value="<?php echo $config->fromname; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="sendmail" size="30" value="<?php echo $config->sendmail; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="smtpport" size="30" value="<?php echo (isset($config->smtpport) ? $config->smtpport : ''); ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="smtpuser" size="30" value="<?php echo $config->smtpuser; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="password" name="smtppass" size="30" value="<?php echo $config->smtppass; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<input class="text_area" type="text" name="smtphost" size="30" value="<?php echo $config->smtphost; ?>" />
			</td>
		</tr>
		</tbody>
	</table>
